...
const AnthonyRobinson = () => {

  return (
    <>
      <Layout>
        <Title title="Anthony Robinson" image={
          <StaticImage 
            alt="" 
            ...
            <div className="flex gap-5">
              <div className="basis-2/3">
                <div className="py-5 lg:py-10 px-5">
                  <h2 className="font-extrabold text-xl lg:text-3xl text-ar-blue">Why we are different</h2>
                </div>
...
export default AnthonyRobinson
